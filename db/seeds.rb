...
Message.create!(author_id: erin.id,body: "You can't talk to me like that.  I didn't do anything wrong.  I've been having a tough day today.",chatroom_id: dm17.id)
...
Message.create!(author_id: pam.id,body: "The party planning committee, minus Angela, has decided that we're all going to do Dwight's Christmas.",chatroom_id: party_planning.id)
Message.create!(author_id: dwight.id,body: "Yes! Yeah!Yeah! Okay! Yes! It's a Christmas Miracle! [High Fives Pam] Yeah! Whoo-Hoo!",chatroom_id: party_planning.id)
Message.create!(author_id: dwight.id,body: "It's a Christmas Miracle!",chatroom_id: party_planning.id)
Message.create!(author_id: dwight.id,body: "Yeah! Whoo-Hoo!",chatroom_id: party_planning.id)
...
Message.create!(author_id: dwight.id,body: "What is going on....?",chatroom_id: dm3.id)
Message.create!(author_id: dwight.id,body: "What are you doing?!",chatroom_id: dm3.id)
...
Message.create!(author_id: creed.id,body: "Hey cuz, heard you're having money problems.",chatroom_id: scranton.id)
